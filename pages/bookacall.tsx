    ...
    <Layout>
      <div className="w-full">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center pb-16">
            <div className="w-full">
              <p className="text-2xl md:text-4xl 2xl:text-4xl leading-[1.5] text-center">
                In today&rsquo;s rapidly evolving digital landscape, staying
                ahead is not just an option—it&rsquo;s a necessity. At Fuzion
                Flow Digital Automation Solutions, we&rsquo;re pioneering the
                next wave of generative AI and robotic process automation
        ...
        <div className="h-screen flex flex-col items-center justify-center px-4 lg:px-16 lg:gap-y-16">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center pb-16">
            <div className="w-full">
              <div className="text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-normal text-center">
                Don&rsquo;t get left behind in the digital race. Experience the
                power of generative AI and robotic process automation with
                Fuzion Flow. Let&rsquo;s co-create the future, one automated
                process at a time.
              </div>
            </div>
          </div>
        ...
        <div className="h-screen flex flex-col items-center justify-center px-4 lg:px-16 lg:gap-y-16">
          ...
          <div>
            <BookButton
              ...
              onClick={() => {
                goToLink(
                  "https://fuzionflow.typeform.com/to/tAxOAGgo?typeform-source=www.google.com"
                );
              }}
            />
          </div>
